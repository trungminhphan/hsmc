        ...
        <div class="login login-with-news-feed">
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="fa fa-home"></span> ĐĂNG NHẬP
                        <small>HỆ THỐNG QUẢN LÝ HỒ SƠ MINH CHỨNG</small>
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="margin-bottom-0" id="loginform">
                        ...
                        <div class="login-buttons">
                            <button type="submit" name="submit" id="submit" class="btn btn-primary btn-block btn-lg">Đăng nhập hệ thống</button>
                        </div>
                        <hr />
                    </form>
                </div>
